...
fetch('https://data.rennesmetropole.fr/api/explore/v2.1/catalog/datasets/decheteries_plateformes_vegetaux/exports/geojson?lang=fr&timezone=Europe%2FBerlin')
  ...
  .then(data => {
    ...
    map.on('load', () => {
       ...
       */
         //Ajout des limites communales de rennes metropole
    ...
    function createPopUp(currentFeature) {
      ...
      const popup = new maplibregl.Popup({ closeOnClick: true })
        ...
        .setHTML(
          //// Reprendre {currentFeature.properties.horaires} pour afficher le nom de la déchetterire et utiliser .split('/').join('<br>') pour remplacer le / en saut de ligne
